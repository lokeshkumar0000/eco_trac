...
class HistoryTableView extends StatefulWidget {
  ...
  HistoryTableView({Key? key}) : super(key: key);

  @override
  _HistoryTableViewState createState() => _HistoryTableViewState();
}
...
List<Avg> getAvgData() {
  return [
    Avg("16-12-2023", 143315, 30807, false),
    Avg("19-11-2023", 187504, 25404, true),
    Avg("27-10-2023", 189840, 34900, true),
  ];
}
...
class Avg {
  Avg(this.date, this.units_consumed, this.average_units_consumed, this.status);
  final String date;
  final int units_consumed;
