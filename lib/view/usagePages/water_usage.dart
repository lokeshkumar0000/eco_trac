...
class WaterConsumptionTableView extends StatefulWidget {
  /// Creates the home page.
  WaterConsumptionTableView({Key? key}) : super(key: key);

  @override
  _WaterConsumptionTableViewState createState() => _WaterConsumptionTableViewState();
}

class _WaterConsumptionTableViewState extends State<WaterConsumptionTableView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Water usage DataGrid'),
      ),
      body: Column(
        children: [
          SfDataGrid(
...
class Avg {
  Avg(this.date, this.units_consumed, this.average_units_consumed,);
  final String date;
  final int units_consumed;
...
class EmployeeDataSource extends DataGridSource {
  ...
  EmployeeDataSource({required List<DataSet> employeeData}) {
    _employeeData = employeeData
        .map<DataGridRow>((e) => DataGridRow(cells: [
              ...
              DataGridCell<int>(
                  columnName: 'ltr consumed', value: e.units_consumed),
  ...
  DataGridRowAdapter buildRow(DataGridRow row) {
    ...
    return DataGridRowAdapter(
      ...
      return Container(
        color: e.value == "16-12-2023" ? ColorConstants.blue : Colors.white,
        alignment: Alignment.center,
        padding: EdgeInsets.all(8.0),
  ...
  AvgDataSource({required List<Avg> employeeData}) {
    _employeeData = employeeData
        .map<DataGridRow>((e) => DataGridRow(cells: [
              ...
              DataGridCell<int>(
                columnName: 'Average ltr ',
                value: e.average_units_consumed,
              ),
              DataGridCell<int>(
                  columnName: 'ltr consumed this month',
